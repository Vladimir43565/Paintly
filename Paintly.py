...
class PaintlyApp:
    def __init__(self, root):
        ...
        # Tracking for Stabilizer/Shapes
        self.points = []
    ...
    def setup_ui(self):
        # Sidebar
        self.sidebar = tk.Frame(self.root, bg="#34495e", width=160, padx=10, pady=10)
        ...
        # Advanced Toggles
        tk.Label(self.sidebar, text="FEATURES", fg="white", bg="#34495e", font=("Arial", 8, "bold")).pack()
    ...
    def paint(self, event):
        ...
        # Stabilizer (Smoothing) Logic
        if self.stabilizer_on.get() and self.brush_type == "Solid":
            # Lerp: Current position follows mouse at 30% speed to kill jitter
    ...
    def detect_shapes(self):
        ...
        # Straight Line Recognition
            ...
            # Check if mouse didn't curve too much
